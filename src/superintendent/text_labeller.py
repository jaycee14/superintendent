...
from .controls import Submitter, MulticlassSubmitter
from .queueing import SimpleDatabaseQueue


class TextLabeller(Labeller):
    """
    ...
    def __init__(
        ...
        *,
        ...
        queue = SimpleDatabaseQueue(db_string=db_string, message_type=message_type)
